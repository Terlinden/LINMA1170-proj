...
LIB_DIR := $(GMSH_DIR)/lib/libgmsh.so # specify library directories for compilation
...
OBJS := elasticity.o lu.o matrix.o design.o project.o eigen.o optimization.o animation.o
...
$(PROG): $(OBJS)
	$(CC) -g -o $@ $^ $(LIB_DIR) $(LDLIBS) $(LDFLAGS) -lm -fopenmp
